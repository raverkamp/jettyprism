 ...
 * operations" that concrete subclasses define to implement step of
 * algorithm()<BR>
 * <BR>
...
public final class UploadRequest extends HttpServletRequestWrapper {
    ...
    /**
     * This RequestParameters stores Vectors with the parameter values extracted
     * from the multipart/form-data request Files uploaded are stored as
    ...
    /**
     *********************************************************** added the
     * following HttpServletRequest interface methods for ServletApi 2.2 (dld -
     * 02/05/2001)
     */
    /**
    ...
    /**
     *********************************************************** added the
     * following ServletRequest interface methods for ServletApi 2.2 (dld -
     * 02/05/2001)
     */
    /**
    ...
    /**
     * The workhorse method that actually parses the request. A subclass can
     * override this method for a better optimized or differently behaved
     * implementation.
     */
    // LXG: removed SQLException as it is not thrown
