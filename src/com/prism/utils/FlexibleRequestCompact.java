...
/**
 * This class transforms an HttpServeletRequest in a new request which has two
 * parameters, implements new functionality compatible with mod_plsql, see
 * Feature request 626981
 * http://sourceforge.net/tracker/index.php?func=detail&aid=626981&group_id=56183&atid=479655
 * Example: If you send the following URL:
 * http://www.acme.com/pls/mydad/!scott.my_proc?x=john&y=10&z=doe The
 * exclamation mark prefix (!) instructs DBPrism to use flexible parameter
 * passing. It invokes procedure scott.myproc and passes it the following two
 * arguments: name_array ==> (`x', `y', `z') values_array ==> ('john', '10',
 * 'doe')
 */
public class FlexibleRequestCompact extends HttpServletRequestWrapper {
    ...
    /**
     * This Hastable stores Vectors with the parameter values extracted from the
     * request
     */
    ...
    /**
     *********************************************************** added the
     * following HttpServletRequest interface methods for Servlet API 2.2 (dld -
     * 02/05/2001)
     */
    /**
     ...
     * header, or <code>null</code> if the request does not have any headers of
     * that name
     */
    ...
    /**
     *********************************************************** added the
     * following ServletRequest interface methods for Servlet API 2.2 (dld -
     * 02/05/2001)
     */
    /**
    ...
    /**
     *********************************************************** added the
     * following HttpServletRequest interface methods for ServletApi 2.3 (mfo -
     * 11/04/2002)
     */
     ...
     * multiple values, only the firts one is returned.
     */
