...
/**
 * This class transforms an HttpServeletRequest in a new request which has two parameters,
 * implements new functionality compatible with mod_plsql, see Feature request 626981
 ...
 * The exclamation mark prefix (!) instructs DBPrism to
 * use flexible parameter passing. It invokes procedure
 * scott.myproc and passes it the following two arguments:
 *    name_array ==> (`x', `y', `z')
