...
/**
 * This class transforms an HttpServeletRequest in a new request which has four
 * parameters, ej:
 * http://www.acme.com/pls/myDAD/!scott.my_pkg.my_proc?x=a&y=b&x=c num_entries
 * ==] 3 name_array ==] (`x', `y', `x'); value_array ==] (`a', `b', `c')
 * reserved ==] ()
 */
