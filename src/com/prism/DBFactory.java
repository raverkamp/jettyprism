...
/**
 * This class plays the role of an AbstractFactory of the Abstract Factory
 * pattern. It has as many subclasses as databases are supported. For each new
 * database a new subclass must be created. It declares an interface for
 * operations that create Abstract Product objects.<BR>
 * <BR>
 ...
 * <BR>
 * Modified: 3/Feb/2004 by <a href="mailto:pyropunk@usa.net">Alexander
 * Graesser</a> (LXG)<BR>
