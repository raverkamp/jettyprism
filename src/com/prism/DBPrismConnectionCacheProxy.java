 ...
 * through the static getInstance(). Also acts as proxy for the implementation
 * of the CacheScheme defined by the user using prism.properties's
 * Manager.class. When the client shuts down it should call the release() method
 * to close all open connections and do other clean up.<BR>
 * <BR>
 * Modified: 20/Mar/2005 by <a href="mailto:jhking@airmail.net">Jason King</a>
 * (JHK)<BR>
 ...
 * <BR>
 * Modified: 13/Apr/2004 by <a href="mailto:pyropunk@usa.net">Alexander
 * Graesser</a> (LXG)<BR>
...
public class DBPrismConnectionCacheProxy {
    ...
    /**
     * Initialization part of getInstance method Initialize TxDicc (Dictionary
     * of Transaction Definition) Initialize ConnInfo (Storing Properties File)
     * Initialize DBConnection (Dicctionary of Connection Definition) Set
     * manager parameter. Creates an instance of DBPrismConnectionCache which
     * implements the methods forwarded by the DBPrismConnectionCacheProxy
     *
     * @param props Configuration
     * @throws Exception
     */
